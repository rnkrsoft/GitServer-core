...
public abstract class DateUtils {
    ...
    static {
        for (DateStyle dateStyle : DateStyle.values()) {
            PATTERNS.put(dateStyle.getMask(), dateStyle);
        }
    }
    ...
    public static String formatJavaDate2String(java.util.Date date, DateStyle dateStyle) {
        ...
        SimpleDateFormat format = new SimpleDateFormat(dateStyle.getFormat());
    ...
    /**
     * 将日起对象格式化为yyyyMMddHHmmssSSS格式的字符串
     * @param date 日期对象
     * @return 字符串
     */
    ...
    public static String getCurrDate() {
        return formatJavaDate2String(new java.util.Date(), DateStyle.FILE_FORMAT6);
    }
    ...
    public static String getCurrTime() {
        return formatJavaDate2String(new java.util.Date(), DateStyle.FILE_FORMAT8);
    }
    ...
    /**
     * 获取当前系统时间戳，否则获取参数的时间戳 格式"yyyyMMddHHmmssSSS";
     */
     ...
     * @param endDate   终点日期
     * @return 返回相差天数, 如果为正数，则终止日期大于起始日期；负数则起始天数大于终止天数
     */
    public static int getDaysBetween(String startDate, String endDate)
            throws IllegalArgumentException {
        Date startD = toDate(startDate);
        Date endD = toDate(endDate);
        return getDaysBetween(startD, endD);
    }
     ...
     * @return 返回相差天数, 如果为正数，则终止日期大于起始日期；负数则起始天数大于终止天数
     */
    public static int getDaysBetween(Date startD, Date endD) {
    ...
    public static String sysdate() {
        return formatJavaDate2String(new Date(), DateStyle.MILLI_FORMAT1);
    }
}
