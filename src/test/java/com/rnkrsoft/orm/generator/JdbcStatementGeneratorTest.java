...
public class JdbcStatementGeneratorTest {
    ...
    public void testInsert() {
        ...
        JdbcStatement statement = new JdbcStatement(JdbcStatementType.INSERT, tableMetadata, columnMetadatas, entity);
    ...
    public void insertSelective() {
        ...
        entity.setUsername("test1");
        entity.setPassword("ssssssssssss");
        JdbcStatement statement = new JdbcStatement(JdbcStatementType.INSERT_SELECTIVE, tableMetadata, new ColumnMetadata[]{tableMetadata.getColumn("username"), tableMetadata.getColumn("password")}, entity);
    ...
    public void deletePrimaryKey() {
        ...
        entity.setUsername("test1");
        entity.setPassword("ssssssssssss");
        JdbcStatement statement = new JdbcStatement(JdbcStatementType.DELETE_PRIMARY_KEY, tableMetadata, null, entity);
    ...
    public void deleteSelective() {
        ...
        entity.setUsername("test1");
        entity.setPassword("ssssssssssss");
        JdbcStatement statement = new JdbcStatement(JdbcStatementType.DELETE_SELECTIVE, tableMetadata, new ColumnMetadata[]{tableMetadata.getColumn("username"), tableMetadata.getColumn("password")}, entity);
    ...
    public void updatePrimaryKey() {
        ...
        entity.setUsername("test1");
        entity.setPassword("ssssssssssss");
        JdbcStatement statement = new JdbcStatement(JdbcStatementType.UPDATE_PRIMARY_KEY, tableMetadata, null, entity);
    ...
    public void updatePrimaryKeySelective() {
        ...
        entity.setUsername("test1");
        entity.setPassword("ssssssssssss");
        JdbcStatement statement = new JdbcStatement(JdbcStatementType.UPDATE_PRIMARY_KEY_SELECTIVE, tableMetadata, new ColumnMetadata[]{tableMetadata.getColumn("username"), tableMetadata.getColumn("password")}, entity);
    ...
    public void testSelectSelective() {
        ...
        UserEntity entity = new UserEntity();
        entity.setPassword("ssssssssssss");
        JdbcStatement statement = new JdbcStatement(JdbcStatementType.SELECT_SELECTIVE, tableMetadata, new ColumnMetadata[]{tableMetadata.getColumn("password")}, entity);
